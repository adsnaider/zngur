...
namespace rust {
  ...
  struct __zngur_internal< ::rust::Unit > {
    ...
    static inline void check_init(const ::rust::Unit&) noexcept {}
    static inline void assume_init(::rust::Unit&) noexcept {}
    static inline void assume_deinit(::rust::Unit&) noexcept {}
  ...
  public:
    ...
    RefMut(const FieldOwned< ::rust::Unit, Offset, Offsets... >& f) {
    ...
    RefMut(const FieldRefMut< ::rust::Unit, Offset, Offsets...>& f) {
        constexpr size_t offset = __zngur_internal_calc_field<Offset, Offsets...>::offset();
  ...
  public:
    ...
    Ref(RefMut< ::rust::Unit > rm) { __zngur_data = rm.__zngur_data; }
    template <typename Offset, typename... Offsets, typename ::std::enable_if<zngur_detail::is_static_offset<Offset, Offsets...>::value, bool>::type = true>
    Ref(const FieldOwned< ::rust::Unit, Offset, Offsets... >& f) {
        constexpr bool heap_allocated = __zngur_internal_calc_field<Offset, Offsets...>::heap_allocated();
        constexpr size_t offset = __zngur_internal_calc_field<Offset, Offsets...>::offset();
        if (heap_allocated) { __zngur_data = *reinterpret_cast<const size_t*>(&f) + offset; }
        else { __zngur_data = reinterpret_cast<size_t>(&f) + offset; }
    ...
    template <typename Offset, typename... Offsets, typename ::std::enable_if<zngur_detail::all_static_offset<Offset, Offsets...>::value, bool>::type = true>
    Ref(const FieldRef< ::rust::Unit, Offset, Offsets...>& f) {
        constexpr size_t offset = __zngur_internal_calc_field<Offset, Offsets...>::offset();
        __zngur_data = *reinterpret_cast<const size_t*>(&f) + offset;
    }
    template <typename Offset, typename... Offsets, typename ::std::enable_if<!zngur_detail::all_static_offset<Offset, Offsets...>::value, bool>::type = true>
    ...
    template <typename Offset, typename... Offsets, typename ::std::enable_if<zngur_detail::all_static_offset<Offset, Offsets...>::value, bool>::type = true>
    Ref(const FieldRefMut< ::rust::Unit, Offset, Offsets...>& f) {
        constexpr size_t offset = __zngur_internal_calc_field<Offset, Offsets...>::offset();
        __zngur_data = *reinterpret_cast<const size_t*>(&f) + offset;
    }
    template <typename Offset, typename... Offsets, typename ::std::enable_if<!zngur_detail::all_static_offset<Offset, Offsets...>::value, bool>::type = true>
  ...
  struct __zngur_internal< Ref < ::rust::Unit > > {
    static inline uint8_t* data_ptr(const Ref < ::rust::Unit >& t) noexcept { return const_cast<uint8_t*>(reinterpret_cast<const uint8_t*>(&t.__zngur_data)); }
  ...
  struct __zngur_internal< Raw < ::rust::Unit > > {
    static inline uint8_t* data_ptr(const Raw < ::rust::Unit >& t) noexcept { return const_cast<uint8_t*>(reinterpret_cast<const uint8_t*>(&t.__zngur_data)); }
  ...
  struct __zngur_internal< RawMut < ::rust::Unit > > {
    static inline uint8_t* data_ptr(const RawMut < ::rust::Unit >& t) noexcept { return const_cast<uint8_t*>(reinterpret_cast<const uint8_t*>(&t.__zngur_data)); }
